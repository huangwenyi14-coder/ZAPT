...
The participant-safe tactic ID/name catalog is available in the repository at
`docs/reference/ATTACK_TACTICS_v18.1.json`. It contains only public ATT&CK
metadata and no dataset or scoring answers.
...
The repository-level ID contract is documented in
`docs/reference/RECORD_IDENTITY_AND_ID_GENERATION.md`, including the exact
generation formulas, uniqueness boundaries, stability rules, and evaluation
keys for all four ID levels.
