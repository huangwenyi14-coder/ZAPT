...
The `EvidenceForge` maintainers take all security issues in the project
seriously. Thank you for improving the security of `EvidenceForge`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`EvidenceForge` leverages GitHub's private vulnerability reporting.
...
reach out via the [Cisco Open Source security contact email](mailto:oss-security@cisco.com).
